    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm leading-relaxed text-gray-800 dark:text-gray-200 font-medium whitespace-pre-wrap">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm">
                ...
                {[1,2,3,4].map(i => (
                  ...
                  >
                    ...
                    <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                      selections.answer === i ? 'border-indigo-600 bg-indigo-600' : 'border-gray-200 group-hover:border-indigo-300'
                    }`}>
             ...
             <div className="mt-8 flex justify-end">
                <button 
                  ...
                  className="px-10 py-4 bg-indigo-600 text-white font-black rounded-2xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-600/20 disabled:opacity-50"
                >
                  Submit Reading Task
                </button>
             </div>
        ...
        <div className="space-y-6">
          ...
          {result && (
             <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 border-2 border-emerald-500/20 shadow-2xl animate-in slide-in-from-right-8 duration-500">
                <div className="text-center mb-6">
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Score</p>
                  <div className="text-4xl font-black text-indigo-600">{result.score || 0}</div>
                </div>
                ...
                <button onClick={() => navigate('/pte')} className="w-full mt-6 py-3 bg-indigo-600 text-white font-black rounded-xl hover:bg-indigo-700 transition-all text-xs">
                  Continue Practice
                </button>
             </div>
          )}
